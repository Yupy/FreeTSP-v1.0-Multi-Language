...
$site_online           = <#site_online#>;              # Set To False To Turn Site Offline.  To Set Back Online Edit This File
...
$signup_timeout        = <#signup_timeout#> * 86400;   # Default 3 Days
...
$torrents_allfree      = <#torrents_allfree#>;                # Set To True To Make All Torrents Free To Download
$peer_limit            = <#peer_limit#>;                      # Max Number Peers Allowed Before Torrents Start To Be Deleted
                                                              # To Make Room
$announce_interval     = <#announce_interval#>;               # Default 30 Mins
$max_torrent_size      = <#max_torrent_size#>;                # Max Torrent File Size Allowed
$max_dead_torrent_time = <#max_dead_torrent_time#> * 3600;    # Default 3 Hours
...
## Torrent Wait Times ##
########################
$waittime       = <#waittime#>;          # Activate Waiting Times For Downloading
$max_class_wait = <#max_class_wait#>;    # Class Selected And Classes Below Will Incure Wait Times
$ratio_1        = <#ratio_1#>;           # Min Ratio Setting For 1st Wait Time
$gigs_1         = <#gigs_1#>;            # Min Upload Setting For 1st Wait Time
$wait_1         = <#wait_1#>;            # Wait Time Setting For 1st Wait Time
$ratio_2        = <#ratio_2#>;           # Min Ratio Setting For 2nd Wait Time
$gigs_2         = <#gigs_2#>;            # Min Upload Setting For 2nd Wait Time
$wait_2         = <#wait_2#>;            # Wait Time Setting For 2nd Wait Time
$ratio_3        = <#ratio_3#>;           # Min Ratio Setting For 3rd Wait Time
$gigs_3         = <#gigs_3#>;            # Min Upload Setting For 3rd Wait Time
$wait_3         = <#wait_3#>;            # Wait Time Setting For 3rd Wait Time
$ratio_4        = <#ratio_4#>;           # Min Ratio Setting For 4th Wait Time
$gigs_4         = <#gigs_4#>;            # Min Upload Setting For 4th Wait Time
$wait_4         = <#wait_4#>;            # Wait Time Setting For 4th Wait Time

####################
## Forums Setings ##
####################
$maxfilesize        = <#maxfilesize#> * 1024 * 1024;        # The Max File Size Allowed To Be Uploaded - Default: 1024*1024 = 1MB
$attachment_dir     = ROOT_DIR . "<#attachment_dir#>";      # The Path To The Attachment Dir, No Slahses
$forum_width        = '<#forum_width#>%';                   # The Width Of The Forum, In Percent, 100% Is The Full Width - Note:
...
$posts_read_expiry  = <#posts_read_expiry#> * 86400;        # Read Post Expiry Time For Forums
#$postsperpage       = (empty(user::$current['postsperpage']) ? <#postsperpage#>: (int)$CURUSER['postsperpage']); # Get The Users Posts Per Page, No Need To Change
...
$limit              = <#limmit#>;               # If There Are More Than $limit (default 10) Posts In The Last $minutes
                                                # (default 5)
                                                # Minutes, It Will Give Them A Error... -- Note: Requires The Flood Mod
                                                # Set To True
$minutes            = <#minutes#>;              # If There Are More Than $limit(default 10) Posts In The Last $minutes
                                                # (default 5)
                                                # Minutes, It Will Give Them A Error... -- Note: Requires The Flood Mod
                                                # Set To True
######################
## Cleanup Settings ##
######################
$staff_log           = <#staff_log#> * 86400;                     # Default Setting Is 7 Days
$site_log            = <#site_log#> * 86400;                      # Default Setting Is 7 Days
$parked_users        = <#parked_users#> * 86400;                  # Default Setting Is 175 Days
$inactive_users      = <#inactive_users#> * 86400;                # Default Setting Is 40 Days
$old_login_attempts  = <#old_login_attempts#> * 86400;            # Default Setting Is 1 Day
$old_help_desk       = <#old_help_desk#> * 86400;                 # Default Setting Is 7 Days
$promote_upload      = <#promote_upload#> * 1024 * 1024 * 1024;   # Default Setting Is 25 GB
$promote_ratio       = <#promote_ratio#>;                         # Default Setting Is 1.05
$promote_time_member = <#promote_time_member#> * 86400;           # Default Setting Is 4 Weeks
$demote_ratio        = <#demote_ratio#>;                          # Default Setting Is 0.95
