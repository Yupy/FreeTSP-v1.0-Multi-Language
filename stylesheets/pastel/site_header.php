<?php
$lang = array_merge(load_language('style_default_header'));
?>
    ...
    <table width='100%' cellspacing='0' cellpadding='0' style='background: transparent'>
        <tr>
            <td class='clear'>
                <div align='center'>
                    <a href='index.php'>
                        <img src='<?php echo $image_dir?>logo.png' width='486' height='100' border='0' alt='<?php echo $site_name?>' title='<?php echo $site_name?>' style='vertical-align : middle;' />
                    </a>
                </div>
            </td>
            <td class='clear' align='right' width='49%'>
                <a href='donate.php'>
                    <img src='<?php echo $image_dir?>donor/donate.png' width='170' height='58' border='0' alt='<?php echo $lang['img_alt_donation']?>' title='<?php echo $lang['img_alt_donation']?>' />
                </a>
            </td>
        </tr>
    </table>
