...
function begin_frame ($caption='', $center=false, $padding=10)
{
    ...
    print("<table border='0' width='100%' cellspacing='0' cellpadding='$padding'><tr><td $tdextra>\n");
}
...
function begin_table ($fullwidth=false, $padding=5)
{
    ...
    print("<table class='main' border='0' $width cellspacing='0' cellpadding='$padding'>");
}
...
/*
        ...
        */
            ...
            $edit = (get_user_class() >= UC_MODERATOR || ($arr['userid'] == user::$current['id']) && (user::$current['class'] >= UC_POWER_USER && user::$current['class'] <= UC_MODERATOR) ? "<a href='shoutbox.php?edit=".$arr["id"]."&amp;user=".$arr['userid']."'><img src='{$image_dir}edit.png' width='16' height='16' border='0' alt='Edit Shout' title='Edit Shout' style='vertical-align:bottom;' /></a> " : '');
...
function StatusBar()
{
    global $image_dir, $site_reputation, $lang, $db;
    ...
    $upped   = mksize($statusbar_stats['uploaded']);
    $downed  = mksize($statusbar_stats['downloaded']);
    ...
    {
         $StatusBar = "<tr>"."<td colspan='2' style='padding: 2px;'>"."<div id='statusbar'>"."<p class='home'>Welcome back, ".format_username(user::$current)."&nbsp; ".$usrclass."&nbsp;[<a href='logout.php'>Logout</a>] Invites: <a href='invite.php'>".security::html_safe($statusbar_stats['invites'])."</a> Reputation Points : ".user::$current['reputation']."</p>"."<p>".date(DATE_RFC822)."</p><p>";
    }
    else
    {
         $StatusBar = "<tr>"."<td colspan='2' style='padding: 2px;'>"."<div id='statusbar'>"."<p class='home'>Welcome back, ".format_username(user::$current)."&nbsp; ".$usrclass."&nbsp;[<a href='logout.php'>Logout</a>] Invites: <a href='invite.php'>".security::html_safe($statusbar_stats['invites'])."</a></p>"."<p>".date(DATE_RFC822)."</p><p>";
    }
