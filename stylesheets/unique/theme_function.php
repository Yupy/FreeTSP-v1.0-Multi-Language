...
function sb_images()
{
    ...
    $lang = array_merge(load_language('style_unique_theme'));
...
function StatusBar()
{
    global $image_dir, $site_reputation, $Memcache, $db;
    ...
    echo("<tr><td class='status' height='32'>" . format_username(user::$current) . "&nbsp;$usrclass</td></tr>");
    echo("<tr><td class='status_time' height='32'>&nbsp;" . date(DATE_RFC822) . "</td></tr>");

    echo("<tr>
              <td class='status' height='32'>
                  <img src='stylesheets/unique/images/ratio.png' width='12' height='12' alt='' title='{$lang['img_alt_ratio']}' />&nbsp;&nbsp;&nbsp;{$lang['table_ratio']}&nbsp;$ratio
              </td>
          </tr>");

    echo("<tr>
              <td class='status' height='32'>
                  <img src='stylesheets/unique/images/share.png' width='10' height='10' border='0' alt='' title='{$lang['img_alt_stats']}' />&nbsp;&nbsp;
                  <img src='stylesheets/unique/images/up.png' width='10' height='10' border='0' alt='' title='{$lang['img_alt_uploaded']}' />&nbsp;$upped&nbsp;
                  <img src='stylesheets/unique/images/down.png' width='10' height='10' border='0' alt='' title='{$lang['img_alt_downloaded']}' />&nbsp;$downed
              </td>
          </tr>");

    echo("<tr>
              <td class='status_time' height='32'>
                  <img src='stylesheets/unique/images/active.png' width='12' height='12' border='0' alt='' title='{$lang['img_alt_active_tor']}' />&nbsp;&nbsp;&nbsp;Active Torrents&nbsp;&nbsp;&nbsp;
                  <img src='stylesheets/unique/images/up.png' width='10' height='10' border='0' alt='' title='{$lang['img_alt_active_ul']}' />&nbsp;{$seedleech['yes']}&nbsp;&nbsp;
                  <img src='stylesheets/unique/images/down.png' width='10' height='10' border='0' alt='' title='{$lang['img_alt_active_ul']}' />&nbsp;{$seedleech['no']}
              </td>
          </tr>");
    ...
    if ($site_reputation == true)
    {
        echo("<tr>
                  <td class='status' height='32'>
                      <img src='stylesheets/unique/images/rep.png' width='12' height='12' border='0' alt='' title='{$lang['img_alt_rep']}' />&nbsp;&nbsp;&nbsp;{$lang['table_points']}: " . user::$current['reputation'] . "
                  </td>
              </tr>");
    }
    ...
    echo("<tr>
              <td class='status' height='32'>
                  <img src='stylesheets/unique/images/invite.png' width='12' height='12' border='0' alt='' title='{$lang['img_alt_invites']}' />&nbsp;&nbsp;&nbsp;{$lang['table_invites']}: <a href='invite.php'>". security::html_safe($statusbar_stats['invites']) . "</a>
              </td>
          </tr>");

    echo("<tr>
              <td class='status' height='32'>
                  <img src='stylesheets/unique/images/mail.png' width='12' height='12' border='0' alt='' title='{$lang['img_alt_msg']}' />&nbsp;&nbsp;&nbsp;<a href='messages.php'>$inbox</a>
              </td>
          </tr>");

    echo("<tr>
              <td class='status' height='32'>
                  <img src='stylesheets/unique/images/donate.png' width='12' height='12' border='0' alt='' title='{$lang['img_alt_donate']}' />&nbsp;&nbsp;&nbsp;<a href='donate.php'>{$lang['table_donate']}</a>
              </td>
          </tr>");
...
/*
    echo("<tr>
              <td class='status' height='32'>
                  <img src='stylesheets/unique/images/leave.png' width='12' height='12' border='0' alt='' title='{$lang['img_alt_logout']}' />&nbsp;&nbsp;&nbsp;<a href='logout.php'>{$lang['table_logout']}</a>
              </td>
          </tr>");
*/
}
