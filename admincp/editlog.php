...
$lang = array_merge(load_language('adm_editlog'),
                    load_language('adm_global'));

site_header("{$lang['title_file_log']}", false);
...
{
    return security::html_safe(unsafeChar($var));
}
...
$file_data = CACHE_DIR . 'edit_log/data_' . user::$current['username'] . '.txt';
...
//$directories[] = './functions/geshi/';
$directories[] = './stylesheets/clean/';
$directories[] = './stylesheets/dark/';
$directories[] = './stylesheets/darkx/';
$directories[] = './stylesheets/default/';
$directories[] = './stylesheets/genx/';
$directories[] = './stylesheets/light/';
$directories[] = './stylesheets/pastel/';
$directories[] = './stylesheets/unique/';
//$directories[] = './cache/';
//$directories[] = './functions/dictbreaker/';
$directories[] = './js/';
//$directories[] = './forum_attachments/';
$directories[] = './lang/';
$directories[] = './lang/english/';
...
echo("<table border='1' align='center' width='750' cellspacing='2' cellpadding='5'>
        <tr>
            <td class='colhead' align='center' width='70%'><strong>{$lang['table_new_files']}</strong></td>
            <td class='colhead' align='center'><strong>{$lang['table_added']}</strong></td>
    </tr>");
...
{
    echo("<tr>
            <td align='center' colspan='2'><b>{$lang['table_no_new']}</b></td>
        </tr>");
}

echo("</table>
    <br /><br /><br />
    <table border='1' align='center' width='750' cellspacing='2' cellpadding='5'>
        <tr>
            <td class='colhead' align='center' width='70%'><strong>{$lang['table_new_modify']}</strong></td>
            <td class='colhead' align='center'><strong>{$lang['table_modified']}</strong></td>
    </tr>");
...
{
    echo("<tr>
            <td align='center' colspan='2'><b>{$lang['table_no_modify']}</b></td>
        </tr>");
}
...
echo("</table>
    ...
    <table border='1' align='center' width='750' cellspacing='2' cellpadding='5'>
        <tr>
            <td class='colhead' align='center' width='70%'><strong>{$lang['table_new_delete']}</strong></td>
            <td class='colhead' align='center'><strong>{$lang['table_deleted']}</strong></td>
        </tr>");
...
{
    echo("<tr>
            <td align='center' colspan='2'><b>{$lang['table_no_delete']}</b></td>
        </tr>");
}
        ...
        <table border='1' align='center' width='750' cellspacing='2' cellpadding='5'>
            <tr>
                <td class='colhead' align='center'>
                    <input type='submit' class='btn' name='update' value='{$lang['btn_update']}' />
                </td>
            </tr>
        </table>
    </form>");
