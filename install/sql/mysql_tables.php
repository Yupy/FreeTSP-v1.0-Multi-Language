...
$TABLE[] = "CREATE TABLE config (
  ...
  `site_url` varchar(255) NOT NULL default 'http://www.yoursite.com',
  `announce_url` varchar(255) NOT NULL default 'http://www.yoursite.com/announce.php',
  `site_online` varchar(255) NOT NULL default 'true',
  `members_only` varchar(255) NOT NULL default 'true',
  `site_mail` varchar(255) NOT NULL default 'noreply@freetsp.com',
  `email_confirm` enum('true','false') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'true',
  `site_name` varchar(255) NOT NULL default 'FREETSP',
  `image_dic` varchar(255) NOT NULL default 'images',
  `torrent_dic` varchar(255) NOT NULL default 'torrents',
  `torrents_allfree` varchar(255) NOT NULL default 'false',
  `peer_limit` varchar(255) NOT NULL default '50000',
  `max_members` varchar(255) NOT NULL default '7500',
  `max_users_then_invite` int(10) UNSIGNED DEFAULT '5000' NOT NULL,
  `invites` int(10) UNSIGNED DEFAULT '2500' NOT NULL,
  `signup_timeout` varchar(255) NOT NULL default '3',
  `min_votes` varchar(255) NOT NULL default '3',
  `autoclean_interval` varchar(255) NOT NULL default '900',
  `announce_interval` varchar(255) NOT NULL default '1800',
  `max_torrent_size` varchar(255) NOT NULL default '1000000',
  `max_dead_torrent_time` varchar(255) NOT NULL default '3',
  `posts_read_expiry` varchar(255) NOT NULL default '14',
  `max_login_attempts` varchar(255) NOT NULL default '6',
  `dictbreaker` varchar(255) NOT NULL default 'functions/dictbreaker',
  `delete_old_torrents` varchar(255) NOT NULL default '1',
  `dead_torrents` varchar(255) NOT NULL default '28',
  `site_reputation` enum('true','false') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'false',
  `maxfilesize` varchar(255) NOT NULL default '1',
  `attachment_dir` varchar(255) NOT NULL default 'forum_attachments',
  `forum_width` varchar(255) NOT NULL default '100%',
  `maxsubjectlength` varchar(255) NOT NULL default '80',
  `postsperpage` varchar(255) NOT NULL default '25',
  `use_attachment_mod` varchar(255) NOT NULL default 'true',
  `use_poll_mod` varchar(255) NOT NULL default 'true',
  `forum_stats_mod` varchar(255) NOT NULL default 'true',
  `use_flood_mod` varchar(255) NOT NULL default 'true',
  `limmit` varchar(255) NOT NULL default '10',
  `minutes` varchar(255) NOT NULL default '5',
  `staff_log` varchar(255) NOT NULL default '7',
  `site_log` varchar(255) NOT NULL default '7',
  `parked_users` varchar(255) NOT NULL default '175',
  `inactive_users` varchar(255) NOT NULL default '40',
  `old_login_attempts` varchar(255) NOT NULL default '1',
  `old_help_desk` varchar(255) NOT NULL default '7',
  `promote_upload` varchar(255) NOT NULL default '25',
  `promote_ratio` varchar(255) NOT NULL default '1.05',
  `promote_time_member` varchar(255) NOT NULL default '28',
  `demote_ratio` varchar(255) NOT NULL default '0.95',
  `waittime` enum('true','false') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'false',
  `max_class_wait` varchar(255) NOT NULL default '0',
  `ratio_1` varchar(255) NOT NULL default '0.5',
  `ratio_2` varchar(255) NOT NULL default '0.65',
  `ratio_3` varchar(255) NOT NULL default '0.8',
  `ratio_4` varchar(255) NOT NULL default '0.95',
  `gigs_1` varchar(255) NOT NULL default '5',
  `gigs_2` varchar(255) NOT NULL default '6.5',
  `gigs_3` varchar(255) NOT NULL default '8',
  `gigs_4` varchar(255) NOT NULL default '9.5',
  `wait_1` varchar(255) NOT NULL default '48',
  `wait_2` varchar(255) NOT NULL default '24',
  `wait_3` varchar(255) NOT NULL default '12',
  `wait_4` varchar(255) NOT NULL default '6',
...
$TABLE[] = "CREATE TABLE forum_category (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
$TABLE[] = "CREATE TABLE `users` (
  ...
  `ip` varchar(60) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  ...
  `language` varchar(64) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'english',
