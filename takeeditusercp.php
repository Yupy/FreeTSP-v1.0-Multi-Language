...
$lang = array_merge(load_language('takeeditusercp'),
...
$action = isset($_POST['action']) ? security::html_safe(trim($_POST['action'])) : '';
...
elseif ($action == "signature")
{
    ...
    if (isset($_POST['info']) && (($info = $_POST['info']) != user::$current['info']))
    {
