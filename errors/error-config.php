...
//-- If You Wish That The Script Give Suggestions To Users When They Request A Page With An Old Extention Uncomment Those Two Lines And Enter Your Old And New Pages Extension --//
...
$error401 = '<div style="padding-top:15px; text-align:center;"><img src="/errors/error-images/alert.png" alt="" title="" /></div>';
...
$error403 = '<div style="padding-top:15px; text-align:center;"><img src="/errors/error-images/alert.png" alt="" title="" /></div>';
...
$error404 = '<div style="padding-top:15px; text-align:center;"><img src="/errors/error-images/alert.png" alt="" title="" /></div>';
...
$error500 = '<div style="padding-top:15px; text-align:center;"><img src="/errors/error-images/alert.png" alt="" title="" /></div>';
...
$suspect = '<div style="padding-top:15px; text-align:center;"><img src="/errors/error-images/alert.png" alt="" title="" /></div>';
