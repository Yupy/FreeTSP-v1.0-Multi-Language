...
$lang = array_merge(load_language('viewnfo'),
...
if (user::$current['class'] < UC_POWER_USER || !is_valid_id($id))
{
        die;
}

$r = $db->query("SELECT name,nfo
                FROM torrents
...
echo("<h1>{$lang['text_nfo']}<a href='details.php?id=$id'>" .htmlentities($a['name']) . "</a></h1>
<table border='1' align='center' cellspacing='0' cellpadding='10'>
    <tr>
        <td align='center' width='50%'>
            <a href='viewnfo.php?id={$id}&amp;view=magic' title='{$lang['table_magisk']}'>
            <span style='font-weight : bold;'>{$lang['table_dos']}</span></a></td>
        <td align='center' width='50%'>
            <a href='viewnfo.php?id={$id}&amp;view=latin-1' title='{$lang['table_latin']}'><span style='font-weight : bold;'>{$lang['table_windows']}</span></a></td>
    </tr>
    <tr>
        <td colspan='3'>
